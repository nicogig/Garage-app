...
public class ModifyAthmoSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] web = {
                getString(R.string.athmo_settings),
        ...
        final String[] desc = {
                getString(R.string.athmo_ip_desc),
                getString(R.string.refresh_desc)
        };
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (itemPosition){
                    case 0: Intent i0 = new Intent(getApplicationContext(), nicolagigante.garage.SettingsActivities.Athmo_Settings.class);
                        startActivity(i0);
                        break;
                    case 1: DialogFragment newFragment = new nicolagigante.garage.SettingsActivities.Reset_Athmo_Dialog(getApplicationContext());
